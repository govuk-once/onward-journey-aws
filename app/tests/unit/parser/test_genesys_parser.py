...
class TestGenesysParser(unittest.TestCase):
        ...
        payload = [
            {
                ...
                "table": {
                    "properties": {
                        "caption": {
                            "blocks": [
                                {"type": "Text", "text": {"text": "Financial Data"}}
                            ]
                        }
                    },
                    "rows": [
    ...
    def test_05_empty_and_missing_fields(self):
        ...
        payload = [
            {
                "type": "Paragraph",
                "paragraph": {"blocks": [{"type": "Text", "text": {}}]},
            },  # Missing "text" key
        ...
        payload = [
            {
                "type": "Paragraph",
                "paragraph": {
                    "blocks": [{"type": "Text", "text": {"text": "Before image."}}]
                },
            },
            ...
            {"type": "Video", "video": {"url": "https://example.com/vid.mp4"}},
            {
                "type": "Paragraph",
                "paragraph": {
                    "blocks": [{"type": "Text", "text": {"text": "After video."}}]
                },
            },
        ]
        ...
        payload = [
            {
                ...
                "paragraph": {
                    "blocks": [
                        {"type": "Text", "text": {"text": "Follow these steps:"}}
                    ]
                },
            },
            {
                    ...
                    "rows": [
                        {
                            "cells": [
                                {
                                    "blocks": [
                                        {"type": "Text", "text": {"text": "Status"}}
                                    ]
                                },
                                {
                                    "blocks": [
                                        {"type": "Text", "text": {"text": "Complete"}}
                                    ]
                                },
                            ]
                        }
            ...
            {
                "type": "Paragraph",
                "paragraph": {"blocks": [{"type": "Text", "text": {"text": "Done."}}]},
            },
        ]
                    ...
                    "blocks": [
                        {
                            "type": "ListItem",
                            "blocks": [
                                {"type": "Text", "text": {"text": "First item"}}
                            ],
                        },
                        {
                            "type": "ListItem",
                            "blocks": [
                                {"type": "Text", "text": {"text": "Second item"}}
                            ],
                        },
                    ]
                },
        ...
        payload = [
            {
                ...
                "list": {
                    "blocks": [
                        {
                            "type": "ListItem",
                            "blocks": [{"type": "Text", "text": {"text": "Step one"}}],
                        },
                        {
                            "type": "ListItem",
                            "blocks": [{"type": "Text", "text": {"text": "Step two"}}],
                        },
                    ]
                },
            }
                    ...
                    "rows": [
                        {
                            "cells": [
                                {
                                    "blocks": [
                                        {"type": "Text", "text": {"text": "Header A"}}
                                    ]
                                },
                                {
                                    "blocks": [
                                        {"type": "Text", "text": {"text": "Header B"}}
                                    ]
                                },
                            ]
                        },
                        {
                            "cells": [
                                {
                                    "blocks": [
                                        {"type": "Text", "text": {"text": "Data A"}}
                                    ]
                                },
                                {
                                    "blocks": [
                                        {"type": "Text", "text": {"text": "Data B"}}
                                    ]
                                },
                            ]
                        },
